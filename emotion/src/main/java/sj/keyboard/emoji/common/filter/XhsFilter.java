package sj.keyboard.emoji.common.filter;
...
import sj.keyboard.emoji.EmojiDisplayListener;
import sj.keyboard.emoji.EmojiSpan;
...
public class XhsFilter extends EmoticonFilter {
    ...
    public static final Pattern XHS_RANGE = Pattern.compile("\\[[a-zA-Z0-9_\\u4e00-\\u9fa5]+\\]");
