package inno.tmsclient.widget.dialog
...
import com.ccb.cdialog.OnBottomItemClick
import com.tunyin.R

class BottomDialog {

    private var dialog: BaseDialog? = null
    private val TAG = "TMS_CLIENT"
    ...
    private var boxBody: RelativeLayout? = null
    ...
    private var lyPay:LinearLayout?=null
...
//        boxList = rootView.findViewById(R.id.box_list)
        txtTitle = rootView.findViewById(R.id.tv_pay)
...
//        boxCancel = rootView.findViewById(R.id.box_cancel)
        lyPay = rootView.findViewById(R.id.ly_pay)
        refreshView()
        //列表的高度不大于设置的最大高度
...
//        boxList!!.setBackgroundResource(R.color.white)
//        boxCancel!!.setBackgroundResource(R.color.white)
//        btnCancel!!.text = "取消"
//        if (isNull(title)) {
...
//            txtTitle!!.text = title
//        }
        txtTitle!!.text = "确认支付：$title 钻石"
        boxBody!!.setOnClickListener { dialog!!.dismiss() }
        lyPay?.setOnClickListener {
            onPayClickistener?.onPay(dialog!!,title!!)
        }
...
//            bottomDialog!!.setOnBottomItemClickListeners(itemClick)
        ...
        fun show(context: AppCompatActivity, title: String?,onPayClickistener: OnPayClickistener?, cancelable: Boolean) {
            bottomDialog = BottomDialog().bulid(context)
            bottomDialog!!.setOnPayClickistener(onPayClickistener)
            bottomDialog!!.setTitle(title)
                    .setCancelable(cancelable)
                    .showDialog()
        }
    ...
    private var onPayClickistener: OnPayClickistener? = null


    open fun setOnPayClickistener(onPayClickistener: OnPayClickistener?): BottomDialog {
        this.onPayClickistener = onPayClickistener
        return this
    }


    interface OnPayClickistener{
        fun onPay(dialog: BaseDialog,money:String)
    }
}