...
public abstract class Discovery<T> {
     ...
     * @param data data
     */
    Discovery(@Nullable List<T> data) {
     ...
     */
    public Discovery(int itemResourceId, int loadingResourceId, int failedResourceId) {
     ...
     * @param failedResourceId  layout resource for its failed state
     */
    public Discovery(int headerResourceId, int itemResourceId, int loadingResourceId, int failedResourceId) {
     ...
     * @param failedResourceId  layout resource for its failed state
     */
    public Discovery(int headerResourceId, int footerResourceId, int itemResourceId, int loadingResourceId, int failedResourceId) {
