...
class UnmannedSoundSelection(list: List<DiscoveryEntity.UnmannedSoundBean>?) : StateBroadcast<DiscoveryEntity.UnmannedSoundBean>(R.layout.layout_item_section_head, R.layout.item_broadcat_recycleview, list) {
...
//                }
    ...
    override fun onBindHeaderViewHolder(holder: ViewHolder?) {
        holder?.setText(R.id.headTitle, "无人声")?.setVisible(R.id.headMore, false)
    }
}