...
public abstract class Broadcast<T> {
     ...
     * @param data data
     */
    Broadcast(@Nullable List<T> data) {
     ...
     */
    public Broadcast(int itemResourceId, int loadingResourceId, int failedResourceId) {
     ...
     * @param failedResourceId  layout resource for its failed state
     */
    public Broadcast(int headerResourceId, int itemResourceId, int loadingResourceId, int failedResourceId) {
     ...
     * @param failedResourceId  layout resource for its failed state
     */
    public Broadcast(int headerResourceId, int footerResourceId, int itemResourceId, int loadingResourceId, int failedResourceId) {
