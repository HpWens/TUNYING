...
public abstract class Classify<T> {
     ...
     */
    public Classify(int itemResourceId, int loadingResourceId, int failedResourceId) {
     ...
     * @param failedResourceId  layout resource for its failed state
     */
    public Classify(int headerResourceId, int itemResourceId, int loadingResourceId, int failedResourceId) {
     ...
     * @param failedResourceId  layout resource for its failed state
     */
    public Classify(int headerResourceId, int footerResourceId, int itemResourceId, int loadingResourceId, int failedResourceId) {
