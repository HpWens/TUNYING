...
public class DiscoveryRVAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        for (Map.Entry<String, Integer> entry : sectionViewTypeNumbers.entrySet()) {
            if (viewType >= entry.getValue() && viewType < entry.getValue() + VIEW_TYPE_QTY) {
                Discovery section = sections.get(entry.getKey());
                //设置section 的 context
    ...
    private ViewHolder getItemViewHolder(ViewGroup parent, Discovery section) {
    ...
    private ViewHolder getHeaderViewHolder(ViewGroup parent, Discovery section) {
    ...
    private ViewHolder getFooterViewHolder(ViewGroup parent, Discovery section) {
    ...
    private ViewHolder getLoadingViewHolder(ViewGroup parent, Discovery section) {
    ...
    private ViewHolder getFailedViewHolder(ViewGroup parent, Discovery section) {
     ...
     */
    public void addSection(String tag, Discovery section) {
     ...
     */
    public String addSection(Discovery section) {
     ...
     * @return section
     */
    public Discovery getSection(String tag) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        for (Map.Entry<String, Discovery> entry : sections.entrySet()) {
            Discovery section = entry.getValue();
     ...
     */
    public Discovery getSectionForPosition(int position) {
     ...
     */
    public LinkedHashMap<String, Discovery> getSectionsMap() {
        return sections;
    }
    ...
    public void notifyItemInsertedInSection(String tag, int position) {
        Discovery section = getValidSectionOrThrowException(tag);
    ...
    @NonNull
    private Discovery getValidSectionOrThrowException(String tag) {
        Discovery section = getSection(tag);
