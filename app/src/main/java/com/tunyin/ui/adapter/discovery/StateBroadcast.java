...
public abstract class StateBroadcast<T> extends Discovery<T>{
     ...
     * @param data
     */
    public StateBroadcast(int itemResourceId, List<T> data) {
        super(data);
     ...
     * @param data
     */
    public StateBroadcast(int headerResourceId, int itemResourceId, List<T> data) {
     ...
     * @param data
     */
    public StateBroadcast(int headerResourceId, int footerResourceId, int itemResourceId, List<T> data) {
        this(headerResourceId, itemResourceId, data);
        this.footerResourceId = footerResourceId;
        this.hasFooter = true;
    }

    public StateBroadcast(int itemResourceId) {
        super();
        this.itemResourceId = itemResourceId;
    }
     ...
     */
    public StateBroadcast(int headerResourceId, int itemResourceId) {
        this(itemResourceId);
        this.headerResourceId = headerResourceId;
        this.hasHeader = true;
    }
     ...
     * @param itemResourceId   layout resource for its items
     */
    public StateBroadcast(int headerResourceId, int footerResourceId, int itemResourceId) {
