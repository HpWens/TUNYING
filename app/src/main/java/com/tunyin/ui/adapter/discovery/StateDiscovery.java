...
public abstract class StateDiscovery<T> extends Discovery<T>{
     ...
     * @param data
     */
    public StateDiscovery(int itemResourceId, List<T> data) {
        super(data);
     ...
     * @param data
     */
    public StateDiscovery(int headerResourceId, int itemResourceId, List<T> data) {
     ...
     * @param data
     */
    public StateDiscovery(int headerResourceId, int footerResourceId, int itemResourceId, List<T> data) {
        this(headerResourceId, itemResourceId, data);
        this.footerResourceId = footerResourceId;
        this.hasFooter = true;
    }

    public StateDiscovery(int itemResourceId) {
        super();
        this.itemResourceId = itemResourceId;
    }
     ...
     */
    public StateDiscovery(int headerResourceId, int itemResourceId) {
        this(itemResourceId);
        this.headerResourceId = headerResourceId;
        this.hasHeader = true;
    }
     ...
     * @param itemResourceId   layout resource for its items
     */
    public StateDiscovery(int headerResourceId, int footerResourceId, int itemResourceId) {
