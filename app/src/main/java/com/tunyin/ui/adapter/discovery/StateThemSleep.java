...
public abstract class StateThemSleep<T> extends Discovery<T>{
     ...
     * @param data
     */
    public StateThemSleep(int itemResourceId, List<T> data) {
        super(data);
     ...
     * @param data
     */
    public StateThemSleep(int headerResourceId, int itemResourceId, List<T> data) {
     ...
     * @param data
     */
    public StateThemSleep(int headerResourceId, int footerResourceId, int itemResourceId, List<T> data) {
        this(headerResourceId, itemResourceId, data);
        this.footerResourceId = footerResourceId;
        this.hasFooter = true;
    }

    public StateThemSleep(int itemResourceId) {
        super();
        this.itemResourceId = itemResourceId;
    }
     ...
     */
    public StateThemSleep(int headerResourceId, int itemResourceId) {
        this(itemResourceId);
        this.headerResourceId = headerResourceId;
        this.hasHeader = true;
    }
     ...
     * @param itemResourceId   layout resource for its items
     */
    public StateThemSleep(int headerResourceId, int footerResourceId, int itemResourceId) {
