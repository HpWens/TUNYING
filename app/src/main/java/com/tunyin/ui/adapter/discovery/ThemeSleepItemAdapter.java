...
public class ThemeSleepItemAdapter extends BaseAdapter<DiscoveryEntity.ThemeSleepBean.ListBeanXX> {
    @Override
    ...
    class BroadcastItemViewHolder extends BaseViewHolder<DiscoveryEntity.ThemeSleepBean.ListBeanXX> {
        ...
        @Override
        protected void bindData(final DiscoveryEntity.ThemeSleepBean.ListBeanXX listBean) {
