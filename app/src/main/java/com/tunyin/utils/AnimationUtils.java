...
public class AnimationUtils {
    ...
    public static ValueAnimator animateHeight(final View view, long duration, final int targetHeight) {
...
//        });
    ...
    public static void animateRotation(final View view, long duration, final int targetRotation) {
        if (DEBUG) {
