 ...
 * use of a originBitmap, asset, resource, external file or any other URI.
 *
...
public final class ImageSource {
    ...
    /**
     * Provide a loaded originBitmap for display.
     * @param bitmap originBitmap to be displayed.
     */
    ...
    /**
     * Provide a loaded and cached originBitmap for display. This originBitmap will not be recycled when it is no
     * longer needed. Use this method if you loaded the originBitmap with an image loader such as Picasso
     * or Volley.
     * @param bitmap originBitmap to be displayed.
     */
    ...
    /**
     * Enable tiling of the image. This does not apply to preview images which are always loaded as a single originBitmap.,
    ...
    /**
     * Disable tiling of the image. This does not apply to preview images which are always loaded as a single originBitmap,
     * and tiling cannot be disabled when displaying a region of the source image.
     * @return this instance for chaining.
     */
    ...
    /**
     * Enable or disable tiling of the image. This does not apply to preview images which are always loaded as a single originBitmap,
     * and tiling cannot be disabled when displaying a region of the source image.
     * @return this instance for chaining.
     */
     ...
     * and also a preview image. When displaying a originBitmap object, or not using a preview, you do not need to declare
